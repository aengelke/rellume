...
private:
    ...
    void LiftThreeSame(llvm::Instruction::BinaryOps op, farmdec::Reg rd, farmdec::VectorArrangement va, farmdec::Reg rn, farmdec::Reg rm, bool scalar, bool invert_rhs = false);
    ...
    void LiftSIMDPairwise(std::function<llvm::Value*(llvm::Value*,llvm::Value*)>, farmdec::Reg rd, farmdec::VectorArrangement va, farmdec::Reg rn, farmdec::Reg rm, bool fp = false);
};
